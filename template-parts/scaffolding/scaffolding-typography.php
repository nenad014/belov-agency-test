...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'typography', 'belov-digital-test' ); ?>">
		<?php esc_html_e( 'Typography', 'belov-digital-test' ); ?></h2>
	...
	print_scaffolding_section(
		[
			...
			'usage'       => '<del>Belov Digital Test</del>',
			'output'      => '<p>We use <del>Belov Digital Test</del> wd_s to build themes.</p>',
		]
	);
